...
public class TreeBidiMap<K extends Comparable<K>, V extends Comparable<V>>
     ...
     * El fixup debe ejecutarse ANTES de quitar el nodo si este es negro,
     * para usar su posición como referencia en las rotaciones.
     */
    ...
    /**
     * Actualiza los punteros del padre del nodo que está siendo movido o eliminado.
